...
const artPieces: StreetArtPiece[] = [
    {
        ...
        type: "Subkultura",
        image: "https://images.unsplash.com/photo-1520423465871-0866049020b7?q=80&w=2574&auto=format&fit=crop",
        points: [
            {
                id: 1,
                x: 20,
    ...
    return (
        <section className='w-full py-16 bg-black text-white overflow-hidden border-t border-gray-800'>
            ...
            <div className='flex overflow-x-auto snap-x snap-mandatory gap-8 pb-12 px-4 md:px-12 no-scrollbar'>
                ...
                {/* Next Module Button */}
                <div
                    className='snap-center shrink-0 w-[85vw] md:w-[30vw] flex items-center justify-center bg-white text-black rounded-xl cursor-pointer hover:bg-gray-200 transition-colors group'
                    onClick={onNext}>
