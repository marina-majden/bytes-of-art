...
export default [
    ...
    route("colors", "pages/colors/ColorsHome.tsx"),
    route("colors/design", "pages/colors/ColorsDesign.tsx"),
    route("colors/catalogue", "pages/colors/ColorCatalogue.tsx"),
    route("colors/workshop", "pages/colors/ColorWorkshop.tsx"),
    route("colors/wheel", "pages/colors/ColorTheoryWheel.tsx"),
    route("colors/history", "pages/colors/ColorHistory.tsx"),
    route("colors/game", "pages/colors/ColorGame.tsx"),
    route("colors/lab", "routes/colors.tsx"),
