    ...
    items: [
        {
            ...
            analysis:
                "Roman portraits emphasized military prowess and divine connection. Augustus is depicted as both commander and god-like figure, establishing the template of ruler as both mortal leader and semi-divine entity. The breastplate imagery tells political stories through mythological references.",
        },
        {
            id: "2",
            year: "1540",
        ...
        },
        {
            ...
            analysis:
                "Baroque era portraits used dramatic lighting, rich textures, and opulent settings to emphasize absolute power. Louis XIV's portrait establishes the 'Sun King' mythology - the ruler as center of the universe. Every element from posture to clothing communicates unchallengeable authority.",
        },
        {
            id: "4",
            year: "1865",
